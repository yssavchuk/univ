...
public class ControlPanel extends Frame 
{
  ...
  public void addPhysicalPage( int virtualPageNum , int physicalPage )
  {
    if ( virtualPageNum == 0 )
    {
      l0.setText( "page " + physicalPage );
    }
    else if ( virtualPageNum == 1)
    {
